...
function nsVideoPlugin() {
    for (var c = this.getLis(), b = 0; b < c.length; b++) for (var e = c[b].getElementsByTagName("*"), d = 0; d < e.length; d++) if (e[d].className == "video") {
...
function extendSliderFunForVimeo() {
    ...
    this.playVideo_VM = function (a) {
        if (LIS_VMs.Rdy) this.postToIframe(a, "play"); else {
            var b = this;
            setTimeout(function () {
...
function onYouTubePlayerAPIReady() {
    ...
    _zSlider.playVideo_YT = function (a) {
        if (a.parentNode.parentNode.yplayer) if (typeof a.parentNode.parentNode.yplayer.playVideo == "function") a.parentNode.parentNode.yplayer.playVideo(); else setTimeout(function () {
